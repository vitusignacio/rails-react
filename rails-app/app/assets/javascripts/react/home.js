...
var _shopping_list = __webpack_require__(9);

document.addEventListener('DOMContentLoaded', function () {
  ReactDOM.render(React.createElement(_shopping_list.ShoppingList, { name: 'Today' }), document.querySelector('#content'));
});
...
var ShoppingList = exports.ShoppingList = function (_React$Component) {
  ...
  function ShoppingList(props) {
    ...
    _axios2.default.get('/home/shopping_items').then(function (response) {
      self.setState({
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'ul',
          null,
          this.state.ShoppingListItems.map(function (item) {
            return React.createElement(
              'li',
              { key: (0, _v2.default)(), onClick: _this2.itemClicked.bind(_this2, item) },
              item
            );
          })
        )
...
module.exports = {"Wrapper":"home__Wrapper"};
